...
const std::string episode_t::type = item_type::EPISODE;
...
std::unique_ptr<episode_t> episode_t::from_json(const nlohmann::json &json_object)
{
	...
	output->show = show_t::from_json(json_object["show"]);
